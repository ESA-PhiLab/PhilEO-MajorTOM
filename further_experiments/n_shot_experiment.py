...
#import training_script2 as training_script
...
#for downstream_task in ['building', 'roads', 'lc', ]:                                                               
    ...
    for n_shot in [500]:      
        ...
        for model_name in model_list:   
            ...
            if model_name == 'GeoAware_contrastive_core_nano':
                ...
                args['pretrained_model_path'] = '/home/phimultigpu/phileo_NFS/phileo_data/pretrained_models/Prithvi_EO_V2_600M_TL.pt'     
