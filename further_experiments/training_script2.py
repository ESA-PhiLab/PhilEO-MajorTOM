...
def main(experiment_name:str, downstream_task:str, model_name:str, augmentations:bool=False, batch_size:int=16, 
    ...
    # #weights = torch.load("/home/ndionelis/majortom_test_syncbatchnorm_epoch_250.pt")    
    # weights = torch.load("/home/ndionelis/phileo-precursor_v79_e015.pt") 
    ...
    model.load_state_dict(torch.load('/home/phimultigpu/phileo_NFS/phileo_data/models/phileo-precursor_v99_e025.pt'), strict=False)     
    ...
    # #from Mamba2D.models import * 
    # from Mamba2D.models.mamba2d import Mamba2DBackbone   
    
    # #from Mamba2D.models.mamba2d_classifier import Mamba2DClassifier
    ...
    # #model.load_state_dict(np.load('/home/phimultigpu/phileo_NFS/phileo_data/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0.npz'), strict=False)
    #model.train()                                                            
    ...
    # #model = ViTUperNet(patch_size=16, decoder_in_index = [8,9,10,11])        
    # #model = ViTUperNet(depth=5, decoder_in_index = [1,2,3,4])        
    # #model = ViTUperNet(depth=4, decoder_in_index = [0,1,2,3])  
    
    # # #model.load_state_dict(torch.load('/home/phimultigpu/phileo_NFS/phileo_data/pretrained_models/31102023_MaskedAutoencoderViT/MaskedAutoencoderViT_ckpt.pt', map_location='cpu'), strict=False)  
    # model.train()     
    ...
    # model.vit_encoder.pos_embed.requires_grad = False
    ...
    # #model.load_state_dict(torch.load('/home/phimultigpu/phileo_NFS/phileo_data/majortom_vit_enc_512_32_16_dec_12_8_epoch_16.pt', map_location='cpu'), strict=False)
    ...
    # #model = PhilEO_ViT()                                       
    # #model = PhilEO_ViT().cuda()  
    # #model = PhilEO_ViT()
    # #model = PhilEO_ViT(patch_size=16)
    # #model = PhilEO_ViT(depth=8)
    # #model = PhilEO_ViT(depth=5)
    # #model = PhilEO_ViT(depth=6)
    ...
    #    param.requires_grad = True
    # #model.vit_encoder.pos_embed.requires_grad = False
    # model.encoder.vit_encoder.pos_embed.requires_grad = False
